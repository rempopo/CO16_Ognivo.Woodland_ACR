...
MissionCondition1 = [ 
 "FOBDEAD", {false}, 
 "ФОБ уничтожен, мы отошли"
];

MissionCondition2 = [ "WIPED", { call fnc_isAllDead }, "All dead", 30 ];

MissionCondition3 = [ 
 "FOBDEADCIVHELP", {false}, 
 "ФОБ уничтожен, цивилы отпущены, мы отошли"
];

MissionCondition4 = [ 
 "FOBDEADITADEAD", {false}, 
 "ФОБ уничтожен, итальянцы мертвы, мы отошли"
];

MissionCondition5 = [ 
 "TOTALWIN", {false}, 
 "Все задачи выполнены, мы отошли"
];

MissionCondition6 = [ 
 "ITADEAD", {false}, 
 "Итальянцы мертвы, мы отошли"
];

MissionCondition7 = [ 
 "CIVHELP", {false}, 
 "Цивилы отпущены, мы отошли"
];

MissionCondition8 = [ 
 "FLEE", {false}, 
 "Мы облажались, но отошли"
];

MissionCondition9 = [ 
 "CIVDEAD", {false}, 
 "Мы разъебали артой мирняк в Могилёвке"
];

MissionCondition10 = [ 
 "CAPTURED", {false}, 
 "Мы ничего не сделали и даже не отступили"
];

MissionCondition11 = [ 
 "WINBUTDEAD", {false}, 
 "ФОБ уничтожен, но нас перебили"
];