...
,	ROLE "ЗЕЛЁНЫЙ - Корректировщик снайпера"	HAS [ARTILLERY_ALLOWED, AIRBORNE_ALLOWED, POM_NO] PERMISSIONS
,	ROLE "ЖЁЛТЫЙ - Наводчик БРМ"	HAS [ARTILLERY_ALLOWED, AIRBORNE_ALLOWED, POM_NO] PERMISSIONS
,	ROLE "КРАСНЫЙ - Командир огневой группы"	HAS [ARTILLERY_ALLOWED, AIRBORNE_ALLOWED, POM_NO] PERMISSIONS
,	ROLE "СИНИЙ - Командир огневой группы"	HAS [ARTILLERY_ALLOWED, AIRBORNE_ALLOWED, POM_NO] PERMISSIONS	
